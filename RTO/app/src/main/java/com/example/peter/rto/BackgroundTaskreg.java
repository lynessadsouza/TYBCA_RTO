...
public class BackgroundTaskreg extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        String reg_url = "http://scape360.website/peter/vehinsert.php?classofvehicle=+'&classofvehicle'+typeofbody=+'&typeofbody'+makersname=+'&makersname'+purpose=+'&purpose' + axeltype=+'&axeltype' +noofcylinder=+'&noofcylinder'+cc=+'&cc'+chassisno=+'&chassisno'+engineno=+'&engineno'+unladenweight=+'&unladenweight'+fuel=+'&fuel'+color=+'&color'ownersname=+'&ownersname'";
